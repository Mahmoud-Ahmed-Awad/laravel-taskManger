                    ...
                    <Card className="border-primary/20">
                        ...
                        <CardContent>
                            <div className="grid gap-4">
                                ...
                                <Link href={route('tasks.index')}>
                                    <Button variant="outline" className="w-full justify-start">
                                        <CheckCircle className="mr-2 h-4 w-4" /> View All
                                    </Button>
                                </Link>
                            </div>
                        </CardContent>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium">Welcome to Task Manger</p>
                                        <p className="text-sm text-muted-foreground">Get started by creating your first list or task</p>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
