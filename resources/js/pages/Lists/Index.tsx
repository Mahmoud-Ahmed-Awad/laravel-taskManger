                        ...
                        <Card key={list.id} className="transition-colors hover:bg-accent/50">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <div className="flex gap-2">
                                    <Button variant="ghost" size="icon" onClick={() => handelEdit(list)}>
                            ...
                            <CardContent>
                                ...
                                {list.task_count !== undefined && <p className="mt-2 text-sm text-muted-foreground">{list.task_count} tasks</p>}
                            </CardContent>
                        </Card>
                    ))}
                </div>
